...
uint16_t CCR1_Val2 = TIM3_CCR_MIN;
uint16_t CCR2_Val2 = TIM3_CCR_MIN;
uint16_t CCR3_Val2 = TIM3_CCR_MIN;
uint16_t CCR4_Val2 = TIM3_CCR_MIN;
...
void TIM3_pwm_init(void)
{
  ...
  TIM_TimeBaseStructure2.TIM_Period = TIM3_ARR;
  ...
  TIM_OCInitStructure2.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure2.TIM_Pulse = CCR2_Val2;
  ...
  TIM_OCInitStructure2.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure2.TIM_Pulse = CCR3_Val2;
  ...
  TIM_OCInitStructure2.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure2.TIM_Pulse = CCR4_Val2;

  TIM_OC4Init(TIM3, &TIM_OCInitStructure2);
