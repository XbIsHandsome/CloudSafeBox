...
/* ==================================================================
#     函数介绍: 初始化LCD12864使用的对应IO口:设置为输出态（写状态）#
#     参    数: 无	                                           #
#     返 回 值: 无 						   #
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
================================================================== */
...
/* ==================================================================
#     函数介绍: 初始化LCD12864收发数据使用的对应IO口:设置为输出态（写状态）#
#     参    数: 无	                                           #
#     返 回 值: 无 						   #
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
...
/* ==================================================================
#     函数介绍: 初始化LCD12864收发数据的对应IO口:设置为输入态（读状态）#
#     参    数: 无	                                           #
#     返 回 值: 无 						   #
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
...
/* ==================================================================
#     函数介绍: 判断LCD当前状态是否为忙
#     参    数: CONCTROLLER_CS1, CONCTROLLER_CS2为分别读取对应区间的状态
#     返 回 值: 1: 忙碌状态 0：非忙碌状态 						  
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
================================================================== */
...
/* ==================================================================
#     函数介绍: 向lcd12864中写入命令
#     参  数 1: cmd 写入的8位命令，具体可查命令列表
#     参  数 2: controller_cs 写入命令的分区
#     返 回 值: 无 						   #
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
================================================================== */
...
/* ==================================================================
#     函数介绍: 设置描点的起始位置
#     参  数 1: page 为行的起点  (0~7)
#     参  数 2: column为列的起点 (0~127)
#     返 回 值: 无 						   #
#     注释作者: 文劲松						   #
#     修改时间: 2018 9.17 12:00	   				   #
================================================================== */
